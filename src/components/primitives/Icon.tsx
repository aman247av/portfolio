...
/**
 * The six icons this site actually uses, inlined.
 *
 * Previously this came from an icon package; shipping a dependency to render
 * half a dozen glyphs is not a trade worth making.
 */
const paths = {
  github:
  ...
  if (name in strokes) {
    return (
      <svg
        ...
        aria-hidden="true"
      >
        {strokes[name as keyof typeof strokes]}
      </svg>
    );
  }
